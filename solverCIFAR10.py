...
#from orthognal_head import VisionTransformer # vit with orthogonal head
...
# from own_impl_vit_model import VisionTransformer
from conventional import VisionTransformer
...
class Solver(object):
    def __init__(self, args):
        ...
        # Initialize W&B
        wandb.init(project="4 heads 196 patch 196 emb dim", 
                   name=f"(CIFAR10) conventional", config={ #"xxxx"
            "learning_rate": self.args.lr,
            "epochs": self.args.epochs,
            "batch_size": self.args.batch_size,
            "dataset": "CIFAR10",
            "model_architecture": "conventional"
        })
############################################## READ DATA


        #Get Data loaders from CIFAR10
        self.train_loader,self.val_loader, self.test_loader, self.n_cl, self.task = get_cifar10_loaders(root='./data')
        self.class_labels = {str(i): i for i in range(self.n_cl)}
    ...
    def train(self):
        ...
        for epoch in range(self.args.epochs):
            ...
            if  best_acc > old_best_acc:
                best_acc = test_acc
                torch.save(self.model.state_dict(), os.path.join(self.args.model_path, "best_cifar10_conventional.pt"))
            ...
            torch.save(self.model.state_dict(), os.path.join(self.args.model_path, "CIFAR10-conventional.pt"))
